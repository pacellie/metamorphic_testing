...
def audio_input_visualizer(audio: torch.Tensor) -> str:
    ...
    base_dir = "web_app/static/reports/assets/stt"  # for web app
    Path(base_dir).mkdir(parents=True, exist_ok=True)
    path_spec = os.path.join(base_dir, f"spec_{audio_id}.png")  # nosec
    retrieve_path_spec = os.path.join("assets/stt", f"spec_{audio_id}.png")
    path_waveform = os.path.join(base_dir, f"wavf_{audio_id}.png")  # nosec
    retrieve_path_waveform = os.path.join("assets/stt", f"wavf_{audio_id}.png")  # nosec
    path_audio = os.path.join(base_dir, f"aud_{audio_id}.wav")  # nosec
    retrieve_path_audio = os.path.join("assets/stt", f"aud_{audio_id}.wav")  # nosec
