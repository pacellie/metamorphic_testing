...
class MetamorphicRelation(Generic[T1, T2], metaclass=ABCMeta):
    ...
    def t_first(self, transformation: MetamorphicTransformation[X, T1]) -> MetamorphicRelation[X, T2]:
        """
    ...
    def t_second(self, transformation: MetamorphicTransformation[X, T2]) -> MetamorphicRelation[T1, X]:
        """
